...
const RoomCreate = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(`${url_local}/api/hotels`);
  ...
  const getFacilities = async () => {
    try {
      const response = await fetch(`${url_local}/api/facilities`);
  ...
  const fetchPropertyTypes = async () => {
    try {
      const response = await fetch(`${url_local}/api/roomTypes`);
  ...
  const onFinish = async (values) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${url_local}/api/rooms/partner/create/${hotelId}`,
        updatedValues
      );
